...
const fields = [
  ...
  },
  {
    field: 'repair_limit',
    key: 'repairLimit',
    label: 'ძველი ტექსტის აღდგენა, ჩანაწერი',
    values: [0, 5, 10, 20],
    fallback: 20,
  },
] as const;
    ...
    >
      ...
      {global && (
        <div className="scraper-limit-presets">
          ...
          >
            დამზოგავი: 100 ჩანაწერი · 4 წუთი · 1 გვერდი · 5 აღდგენა
          </button>
      ...
      <p className="admin-helper">
        ცვლილება მოქმედებს შემდეგ გაშვებაზე. ჩანაწერების ლიმიტი მოიცავს ახალსა
        და ძველს ერთად. დროის ამოწურვის შემდეგ ახალი დამუშავება აღარ იწყება;
        მიმდინარე მოთხოვნა სრულდება. ტექსტების აღდგენას ცალკე, მაქსიმუმ 3 წუთი
        აქვს; 0 აჩერებს აღდგენას. პირველი სიის გვერდი ყოველთვის მოწმდება.
        გაშვების გარემოს უფრო დაბალი ლიმიტიც ძალაში რჩება.
      </p>
    </fieldset>
  );
}
