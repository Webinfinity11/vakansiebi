        ...
        >
          ...
          <fieldset className="post-section post-plans">
            ...
            <details className="post-plan-note">
              ...
              <p>
                პრემიუმსა და VIP-ს შესაბამის შედეგებში ცალკე სექციები აქვს,
                თითოეულში სამი ადგილი. განცხადებები მონაცვლეობით ჩანს. ხელფასით,
                თარიღით ან ბოლო ვადით დალაგებისას შენარჩუნდება არჩეული რიგითობა.
              </p>
            </details>
          </fieldset>
